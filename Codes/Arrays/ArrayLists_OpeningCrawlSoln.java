...
public class ArrayLists_OpeningCrawlSoln extends GraphicsProgram {
	...
	private static final String CRAWL_MUSIC_FILENAME = "bounce.au";
	...
	public void run() {
		...
		AudioClip music = getAudioClip(getCodeBase(),CRAWL_MUSIC_FILENAME);
		music.play();
	...
	private ArrayList<GLabel> readOpeningCrawlFile(String crawlFilename) {
		try {
			/*
			Scanner rd = new Scanner(new File(crawlFilename));
