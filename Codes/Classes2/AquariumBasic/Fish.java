...
public class Fish {
	...
	private void trueFacing (double dx)	{
		boolean shouldFacingLeft = (dx < 0);
		if (shouldFacingLeft != isFacingLeft)
			isFacingLeft = shouldFacingLeft;
		if (isFacingLeft)
			img.setImage("blueFishLeft");
		else
			img.setImage("blueFishRight");
